 ...
 */
final class Version20201126085942 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE cdrom (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, cote VARCHAR(255) NOT NULL, availability TINYINT(1) NOT NULL, picture VARCHAR(255) NOT NULL, searchable TINYINT(1) NOT NULL, authtor VARCHAR(255) NOT NULL, bail DOUBLE PRECISION NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE livre (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, cote VARCHAR(255) NOT NULL, availability TINYINT(1) NOT NULL, picture VARCHAR(255) NOT NULL, searchable TINYINT(1) NOT NULL, authtor VARCHAR(255) NOT NULL, special TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE micro_film (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, cote VARCHAR(255) NOT NULL, availability TINYINT(1) NOT NULL, picture VARCHAR(255) NOT NULL, searchable TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE news_paper (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, cote VARCHAR(255) NOT NULL, availability TINYINT(1) NOT NULL, picture VARCHAR(255) NOT NULL, searchable TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ressource (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, cote VARCHAR(255) NOT NULL, availability TINYINT(1) NOT NULL, picture VARCHAR(255) NOT NULL, searchable TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
