 ...
 */
final class Version20201201110120 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE loan CHANGE searchable searchable TINYINT(1) DEFAULT NULL, CHANGE status status TINYINT(1) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE loan CHANGE searchable searchable TINYINT(1) NOT NULL, CHANGE status status TINYINT(1) NOT NULL');
    }
}
