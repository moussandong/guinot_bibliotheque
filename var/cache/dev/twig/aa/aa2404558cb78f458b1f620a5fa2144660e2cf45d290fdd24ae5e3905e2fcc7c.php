...
class __TwigTemplate_d1673f14f5d53f57f1d0a86a61ad9b258456d889be9b9b9b57a62f771b6dfa39 extends Template
{
    private $source;
    private $macros = [];
...
\t\t";
        // line 39
        $this->loadTemplate("shared/table.html.twig", "livre/index.html.twig", 39)->display(twig_array_merge($context, ["titles" => [0 => "title", 1 => "cote", 2 => "availability", 3 => "authtor", 4 => "special", 5 => "action"], "items" => (isset($context["livres"]) || array_key_exists("livres", $context) ? $context["livres"] : (function () { throw new RuntimeError('Variable "livres" does not exist.', 39, $this->source); })()), "detail" => "livre_show", "edit" => "livre_edit"]));
        // line 40
        echo "
\t";
        // line 41
...
\t";
        ...
        // line 46
        echo $this->extensions['Knp\Bundle\PaginatorBundle\Twig\Extension\PaginationExtension']->render($this->env, (isset($context["livres"]) || array_key_exists("livres", $context) ? $context["livres"] : (function () { throw new RuntimeError('Variable "livres" does not exist.', 46, $this->source); })()));
        echo "
";
...
\t\t";
        // line 50
        $this->loadTemplate("filter/_filters.js", "livre/index.html.twig", 50)->display($context);
        echo "</script>
";
    ...
    {
        return array (  179 => 50,  176 => 49,  166 => 48,  154 => 46,  146 => 42,  144 => 41,  141 => 40,  139 => 39,  128 => 31,  115 => 21,  109 => 18,  103 => 15,  97 => 12,  91 => 8,  81 => 7,  70 => 4,  60 => 3,  37 => 1,);
    }
...
\t\t{% include \"shared/table.html.twig\" with {\"titles\" : [\"title\",\"cote\",\"availability\",\"authtor\",\"special\",\"action\"], \"items\": livres,\"detail\": \"livre_show\", \"edit\": \"livre_edit\"} %}

\t{% if is_granted('ROLE_VOLONTEER') %}
\t\t<a class=\"btn btn-warning\" href=\"{{ path('livre_new') }}\">
\t\t\tCréer un nouveau livre
\t\t</a>
\t{% endif %}
...
{% endblock %}
", "livre/index.html.twig", "/Users/ndongmoussa/Desktop/localhost/symfony/GuinotBibliotheque/templates/livre/index.html.twig");
    }
}
